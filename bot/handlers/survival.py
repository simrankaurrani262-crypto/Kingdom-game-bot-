...
💀 Wave 5: 500 Demon Lord - 💰 10,000 Gold"""
    await update.message.reply_text(text=text, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("⚔️ Start Survival", callback_data="survival_start")], [InlineKeyboardButton("🔙 Back", callback_data="back_dashboard")]]), parse_mode='HTML')
